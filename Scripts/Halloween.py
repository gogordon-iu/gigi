...
class Halloween(ScriptGraph) :
    ...
    def init_graph(self):
        ...
        self.graph.add_node('Node_3', type=['speak'], text='I will hide here quietly and scare people')
        self.graph.add_edge('Node_3', 'Node_4', label='Node_3_4')
        self.graph.add_node('Node_4', type=['show'], image='../Assets/Halloween/hide.jpg.png')
        self.graph.add_edge('Node_4', 'Node_5', label='Node_4_5')
        self.graph.add_node('Node_5', type=['find'], what='motion', timeout=4)
        ...
        self.graph.add_node('Node_7', type=['audio', 'show'], audio='scream.wav', image='../Assets/Halloween/scary.png')
