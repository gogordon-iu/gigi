...
class Jorge_yellow(ScriptGraph) :
    ...
    def init_graph(self):
        ...
        self.graph.add_node('Node_7', type=['find'], what='gesture', timeout=10, data=['Fist'])
        ...
        self.graph.add_node('Node_9', type=[])
        self.graph.add_edge('Node_7', 'Node_9', label='timeout')
        self.graph.add_edge('Node_9', 'Node_7', label='Node_9_7')
        self.graph.add_node('Node_10', type=['move', 'show'], motors='rave', video='../Assets/Jorge_yellow/jorge_yellow.mp4', pause={'after': 120})
        self.graph.add_edge('Node_7', 'Node_10', label='Fist')
        self.graph.add_edge('Node_10', 'Node_11', label='Node_10_11')
        self.graph.add_node('Node_11', type=['show'], video='../Assets/Jorge_yellow/jorge_yellow.mp4', pause={'after': 120})
