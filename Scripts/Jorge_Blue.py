...
class Jorge_Blue(ScriptGraph) :
    ...
    def init_graph(self):
        ...
        self.graph.add_node('Node_7', type=['speak', 'move'], text='I do not know any other ways to relate to water, Angel.', motors='look_left')
        ...
        self.graph.add_node('Node_9', type=['speak', 'move'], text='The most sophisticated technology you can think of, has been right in front of you all this time, disguised in plain sight.', motors='open_arms', pause={'after': 30})
