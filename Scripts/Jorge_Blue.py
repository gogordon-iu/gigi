...
class Jorge_Blue(ScriptGraph) :
    ...
    def init_graph(self):
        ...
        self.graph.add_node('Node_3', type=['hear'], words='["Guys", "ridiculous", "[unk]"]', timeout=10)
        ...
        self.graph.add_node('Node_6', type=['speak'], text='I don`t know any other ways to relate to water Angel, you are the one that programmed us. You`ll have to figure this out by yourself. I`m sorry.', pause={'after': 30})
        self.graph.add_edge('Node_6', 'Node_7', label='Node_6_7')
        self.graph.add_node('Node_7', type=['speak'], text='The most sophisticated technology you can think of, has been right in front of you all this time, disguised in plain sight.', pause={'after': 30})
        self.graph.add_edge('Node_7', 'Node_8', label='Node_7_8')
        self.graph.add_node('Node_8', type=['speak'], text='The future is already here, it has been here…', pause={'after': 30})
