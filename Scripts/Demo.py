...
class Demo(ScriptGraph) :
    ...
    def init_graph(self):
        ...
        self.graph.add_node('Node_4', type=['speak', 'move'], text='and you, Emma', motors='look_right', pause={'after': 1})
        self.graph.add_edge('Node_4', 'Node_5', label='Node_4_5')
        self.graph.add_node('Node_5', type=['speak', 'move'], text='Last time we learned about robots in general.', motors='home')
        ...
        self.graph.add_node('Node_17', type=['speak', 'move'], text='That is a great question, Gaia, I also love to learn new things.', motors='look_left')
        self.graph.add_edge('Node_17', 'Node_18', label='Node_17_18')
        self.graph.add_node('Node_18', type=['speak', 'show', 'move'], text='They can sense and respond to human actions, making teamwork between humans and machines easier and safer.', image='../Assets/Demo/face/cobot.jpg', motors='home', pause={'after': 2})
        ...
        self.graph.add_node('Node_25', type=['speak', 'move'], text='Think you can do it? Try', motors='home', pause={'after': 10})
        ...
        self.graph.add_node('Node_31', type=['speak', 'move'], text='Gaia, only do what Emma tells you. Do not act on your own.', motors='look_left')
        self.graph.add_edge('Node_31', 'Node_32', label='Node_31_32')
        self.graph.add_node('Node_32', type=['speak', 'move'], text='Try it out', motors='home', pause={'after': 15})
        self.graph.add_edge('Node_32', 'Node_33', label='Node_32_33')
        self.graph.add_node('Node_33', type=['speak', 'move'], text='That was great.', motors='arms_up')
        self.graph.add_edge('Node_33', 'Node_34', label='Node_33_34')
        self.graph.add_node('Node_34', type=['audio'], audio='laugh.wav')
        self.graph.add_edge('Node_34', 'Node_35', label='Node_34_35')
        self.graph.add_node('Node_35', type=['speak', 'move'], text='Emma, you are an excellent co-bot operator', motors='look_right')
        self.graph.add_edge('Node_35', 'Node_36', label='Node_35_36')
        self.graph.add_node('Node_36', type=['speak', 'move'], text='And you Gaia, you were an excellent co-bot', motors='look_left', pause={'after': 1})
        self.graph.add_edge('Node_36', 'Node_37', label='Node_36_37')
        self.graph.add_node('Node_37', type=['speak', 'move'], text='That is it for today.', motors='home')
        self.graph.add_edge('Node_37', 'Node_38', label='Node_37_38')
        self.graph.add_node('Node_38', type=['speak', 'move'], text='See you next time, Gaia and Emma.', motors='wave_hello')
