...
class Demo(ScriptGraph) :
    ...
    def init_graph(self):
        ...
        self.graph.add_node('Node_4', type=['speak', 'move'], text='and you, Emma', motors='look_right')
        ...
        self.graph.add_node('Node_32', type=['speak', 'move'], text='Try', motors='home', pause={'after': 15})
        ...
        self.graph.add_node('Node_36', type=['speak', 'move'], text='And you Gaia, you were an excellent co-bot', motors='look_left')
